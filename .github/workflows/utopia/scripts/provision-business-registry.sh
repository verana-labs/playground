...
# ECS-Organization (Business IDs) is granted separately by utopia-02.
set -eo pipefail
...
ok "Business Registry provisioned: TR=$TR_ID, CS=$CS_ID. Next: run 'Utopia 02' to accredit it as ECS-Organization issuer."
