      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
        ...
        {wallet.browser ? (
          <p className="text-sm leading-relaxed text-gray-600">
            {wallet.name} is a{" "}
            <strong className="font-semibold text-gray-900">web wallet</strong>{" "}
            - nothing to install. Open it in your browser, on your phone too,
            and create your account with fingerprint, face or PIN.
          </p>
